from car_collect import app, db, oauth
from flask import render_template, request, redirect, url_for, flash,session, jsonify

# drone_api module imports
from car_collect.forms import UserLoginForm
from car_collect.models import User, check_password_hash, Car, car_schema, cars_schema
...
from car_collect.helpers import get_jwt, token_required, verify_owner
...
def create_car(current_user_token):
    ...
    test_user = User.query.filter_by(email = 'ssrt.2596@gmail.com').first()
    ...
    response = drone_schema.dump(car)
